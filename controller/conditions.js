...
module.exports.getAll = async (req, res) => {
	console.log(' conditions getAll ');
	try {
		const connection = mysql.createConnection(keys.connect);
		connection.connect();
		await connection.query(`SELECT * FROM Conditions`, (error, result) => {
...
module.exports.getList = async (req, res) => {
	...
	try {
		const connection = mysql.createConnection(keys.connect);
		connection.connect();
		await connection.query(`SELECT * FROM ConditionsList`, (error, result) => {
			if (error) throw error;
			console.log(result);
			connection.end();
...
// 		const connection = mysql.createConnection(keys.connect);
// 		connection.connect();
// 		await connection.query(`SELECT * FROM Conditions WHERE categoryName = '${req.body.name}' `, (error, result) => {
// 			if (error) throw error;
